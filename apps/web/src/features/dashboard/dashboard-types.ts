...
export type DashboardSection = "overview" | "agent" | "model" | "git" | "worker";
...
export type DashboardTrendPanel = CountPanel | DurationPanel | RatioPanel | ModelRequestPanel | ModelCompletedDurationPanel | TokenPanel | WorkerEventPanel | MonitoringPanel;
