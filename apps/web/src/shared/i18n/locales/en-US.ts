export default {
  ...
  dashboard: {
    ...
    nonMergeCommits: "Non-merge commits", filesChanged: "Files changed", linesAdded: "Lines added", linesDeleted: "Lines deleted", heatmap: "180-day commit heatmap", heatmapLess: "Less", heatmapMore: "More",
