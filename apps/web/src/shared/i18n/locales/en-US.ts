export default {
  ...
  agent: {
    ...
    client: {
      ...
      running: "Running",
      cancel: "Cancel run",
      cancelAnchorMissing: "No valid anchor event found for cancellation",
      cancelConfirmTitle: "Cancel current run?",
      cancelConfirmContent: "This will stop the current execution and roll back to this run's anchor message.",
      ...
      revertTargetMissing: "No previous event found to revert to",
